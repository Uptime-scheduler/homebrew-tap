...
class Uptime < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/Uptime-scheduler/uptime-cli/releases/download/v/uptime-macos-arm64.tar.gz"
      sha256 "ccdc66e4ecb596ed1f1a211e3856d4a30a4b6a86fe3cdd8f1a0216ec8fc1e3b0"
    end
    on_intel do
      url "https://github.com/Uptime-scheduler/uptime-cli/releases/download/v/uptime-macos-x86_64.tar.gz"
